...
#' # The `Builder_ControlMatrix` was developed to help the user to create this matrix.
...
#' # The `Builder_Prior_Knowledge` function was developed to help the user to create these objects.
