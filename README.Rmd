...
```
For instance, the recession model with two exponential terms and asymptotic (`Equation_Rec_M3()`, proposed by @darienzoDetectionEstimationStagedischarge2021) will be considered for the calculation, and it is described below:
