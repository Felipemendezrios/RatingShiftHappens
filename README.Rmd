...
Hereafter, the employed model will be an exponential regression (`fitRC_exponential`), estimating discharge using two parameters, denoted as 'a' and 'b', following this equation : \deqn{Q(h)=a \cdot \exp(b \cdot H)}
